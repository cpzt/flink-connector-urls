 ...
 */
public abstract class URLSingleThreadMultiplexSourceReaderBase<
                E extends IRecord<T>, T, SplitT extends SourceSplit, SplitStateT>
        extends URLSourceReaderBase<E, T, SplitT, SplitStateT> {
     ...
     */
    public URLSingleThreadMultiplexSourceReaderBase(
    ...
    /**
     * This constructor behaves like , but accepts a specific {@link
    ...
    public URLSingleThreadMultiplexSourceReaderBase(
            ...
            Configuration config,
            SourceReaderContext context) {
        super(elementsQueue, splitFetcherManager, addSplitFunction, recordEmitter, config, context);
    }
}
